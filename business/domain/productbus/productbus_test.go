...
import (
	...
	"github.com/owezzy/schoolCRM/business/sdk/unittest"
	"github.com/owezzy/schoolCRM/business/types/money"
	"github.com/owezzy/schoolCRM/business/types/name"
	"github.com/owezzy/schoolCRM/business/types/quantity"
...
func insertSeedData(busDomain dbtest.BusDomain) (unittest.SeedData, error) {
	...
	usrs, err := userbus.TestSeedUsers(ctx, 1, role.Student, busDomain.User)
	if err != nil {
